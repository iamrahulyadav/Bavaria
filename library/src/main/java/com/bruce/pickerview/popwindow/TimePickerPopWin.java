...
//        }
        ...
        public Builder passArr(ArrayList<String> newArr){
            this.newArr = newArr;
            return this;
        }
...
//        cancelBtn.setTextSize(btnTextsize);
        ...
        hourLoopView = (LoopView) contentView.findViewById(R.id.picker_project);
...
//        String str = bundle.getString("jsonCar");
//        ArrayList<String> arraylist = gson.fromJson(str, new TypeToken<ArrayList<String>>() {
//        }.getType());
...
//        meridianPos=Calendar.getInstance().get(Calendar.AM_PM);
        ...
        for (int i = 0; i < newArr.size(); i++) {
            projectList.add(newArr.get(i));
//            projectList.add("hello");
//            projectList.add(format2LenStr(i));
        }
...
//        meridianList.add("PM");
        ...
        hourLoopView.setDataList(projectList);
...
//                String amPm=meridianList.get(meridianPos);
                ...
                sb.append(String.valueOf(projectList.get(hourPos)));
//                sb.append(":");
//                sb.append(String.valueOf(minList.get(minutePos)));
//                sb.append(amPm);
                mListener.onTimePickCompleted(sb.toString());
            }
            dismissPopWin();
        }
    }
...
//    }
    ...
    public interface OnTimePickListener {
        ...
        void onTimePickCompleted(String time);
    }
}
